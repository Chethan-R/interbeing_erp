...
<body>
	<div id="main-wrapper">
		...
		<center><h2>Staff Details Page</h2></center>
		<div class="imgcontainer">
			...
			<div>
			<form action="staffview.php">
            <center><button type="submit" class="btn btn-success"> VIEW STAFF </button><br></center>
			</form>
			</div>
			<br>
			<form action="staffadd.html">
            <center><button type="submit" class="btn btn-success">ADD STAFF</button><br></center><br>
            </form>
